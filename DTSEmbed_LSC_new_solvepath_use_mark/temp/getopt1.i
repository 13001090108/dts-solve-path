# 1 "C:\\Users\\lsc\\Desktop\\testcase\\spell-1.0(1)\\spell-1.0\\getopt.c"
# 1 "<built-in>"
# 1 "<command line>"
...
# 7 "<command line>" 2
# 1 "C:\\Users\\lsc\\Desktop\\testcase\\spell-1.0(1)\\spell-1.0\\getopt.c"
# 54 "C:\\Users\\lsc\\Desktop\\testcase\\spell-1.0(1)\\spell-1.0\\getopt.c"
...
# 55 "C:\\Users\\lsc\\Desktop\\testcase\\spell-1.0(1)\\spell-1.0\\getopt.c" 2
# 97 "C:\\Users\\lsc\\Desktop\\testcase\\spell-1.0(1)\\spell-1.0\\getopt.c"
...
# 105 "C:\\Users\\lsc\\Desktop\\testcase\\spell-1.0(1)\\spell-1.0\\/getopt.h"
  ...
  extern int _getopt_internal (int argc, char *const *argv,
          ...
          const struct option *longopts, int *longind,
          int long_only);
# 98 "C:\\Users\\lsc\\Desktop\\testcase\\spell-1.0(1)\\spell-1.0\\getopt.c" 2
...
char *optarg = 0;
# 120 "C:\\Users\\lsc\\Desktop\\testcase\\spell-1.0(1)\\spell-1.0\\getopt.c"
int optind = 0;
# 129 "C:\\Users\\lsc\\Desktop\\testcase\\spell-1.0(1)\\spell-1.0\\getopt.c"
...
int optopt = '?';
# 171 "C:\\Users\\lsc\\Desktop\\testcase\\spell-1.0(1)\\spell-1.0\\getopt.c"
static enum
  {
    REQUIRE_ORDER, PERMUTE, RETURN_IN_ORDER
  }
ordering;
# 190 "C:\\Users\\lsc\\Desktop\\testcase\\spell-1.0(1)\\spell-1.0\\getopt.c"
char *getenv ();
...
# 224 "C:\\Users\\lsc\\Desktop\\testcase\\spell-1.0(1)\\spell-1.0\\getopt.c"
static int first_nonopt;
static int last_nonopt;
# 236 "C:\\Users\\lsc\\Desktop\\testcase\\spell-1.0(1)\\spell-1.0\\getopt.c"
static void
exchange (argv)
     char **argv;
{
...
# 314 "C:\\Users\\lsc\\Desktop\\testcase\\spell-1.0(1)\\spell-1.0\\getopt.c"
int
     ...
     int long_only;
{
      ...
      else if (optstring[0] == '+')
 {
   ...
   ++optstring;
      ...
      else if (getenv ("POSIXLY_CORRECT") != ((void *)0))
 ordering = REQUIRE_ORDER;
      else
 ordering = PERMUTE;
    }
 ...
 {
   if (opterr)
     fprintf (((__getreent())->_stderr), "%s: option `%s' is ambiguous\n",
       argv[0], argv[optind]);
      ...
      if (pfound != ((void *)0))
 {
  ...
  {
    if (opterr)
      fprintf (((__getreent())->_stderr), "%s: option `%s' requires an argument\n",
   ...
   || my_index (optstring, *nextchar) == ((void *)0))
 {
   if (opterr)
     {
       if (argv[optind][1] == '-')

  fprintf (((__getreent())->_stderr), "%s: unrecognized option `--%s'\n",
    argv[0], nextchar);
       else

  fprintf (((__getreent())->_stderr), "%s: unrecognized option `%c%s'\n",
 ...
 if (opterr)
   {
# 588 "C:\\Users\\lsc\\Desktop\\testcase\\spell-1.0(1)\\spell-1.0\\getopt.c"
     fprintf (((__getreent())->_stderr), "%s: illegal option -- %c\n", argv[0], c);
  ...
  if (opterr)
    {
      ...
      fprintf (((__getreent())->_stderr), "%s: option requires an argument -- %c\n",
        argv[0], c);
