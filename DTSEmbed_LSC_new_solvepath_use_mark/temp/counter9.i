...
# 191 "/usr/include/sys/config.h" 3 4
# 1 "/usr/include/cygwin/config.h" 1 3 4
# 192 "/usr/include/sys/config.h" 2 3 4
...
# 579 "/usr/include/sys/reent.h" 3 4
struct _reent
{
  int _errno;
...
# 817 "/usr/include/sys/reent.h" 3 4
...
# 440 "/usr/include/sys/types.h" 3 4
...
# 441 "/usr/include/sys/types.h" 2 3 4
...
int f(int k){
    ...
    m = 12;
# 333 "E:\\TESTCASE\\\345\215\225\345\205\203\345\206\205\\test\\counter.c"
while(m >10 ){
   while(i > 0) {
    while(k > 10) {
     k --;
 ...
 for(int j = 0 ; j < 10 ; j ++) {
  for(int h = 0 ; h < 10 ; h ++) {
# 361 "E:\\TESTCASE\\\345\215\225\345\205\203\345\206\205\\test\\counter.c"
   for(int d = 0 ; d < 10 ; d ++) {
