# 1 "C:\\Users\\lsc\\Desktop\\testcase\\uucp-1.07\\contrib\\tstout.c"
# 1 "<built-in>"
# 1 "<command line>"
...
# 7 "<command line>" 2
# 1 "C:\\Users\\lsc\\Desktop\\testcase\\uucp-1.07\\contrib\\tstout.c"
# 18 "C:\\Users\\lsc\\Desktop\\testcase\\uucp-1.07\\contrib\\tstout.c"
...
# 19 "C:\\Users\\lsc\\Desktop\\testcase\\uucp-1.07\\contrib\\tstout.c" 2
...
# 20 "C:\\Users\\lsc\\Desktop\\testcase\\uucp-1.07\\contrib\\tstout.c" 2
...
# 141 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/time.h" 2
...
# 23 "C:\\Users\\lsc\\Desktop\\testcase\\uucp-1.07\\contrib\\tstout.c" 2


# 1 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/utmp.h" 1



# 1 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/sys/utmp.h" 1
# 12 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/sys/utmp.h"
# 1 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/cygwin/utmp.h" 1
# 14 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/cygwin/utmp.h"
# 1 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/paths.h" 1
# 15 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/cygwin/utmp.h" 2
# 13 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/sys/utmp.h" 2
# 25 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/sys/utmp.h"
struct utmp
{
 short ut_type;
 pid_t ut_pid;
...
# 5 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/utmp.h" 2
# 26 "C:\\Users\\lsc\\Desktop\\testcase\\uucp-1.07\\contrib\\tstout.c" 2
     ...
     char **argv;
{
  ...
  if (argc != 2
    ...
    {
      fprintf (((__getreent())->_stderr), "Usage: tstout device\n");
      exit (EXIT_FAILURE);
    }
...
# 85 "C:\\Users\\lsc\\Desktop\\testcase\\uucp-1.07\\contrib\\tstout.c"
static int
logout(line)
 const char *line;
{
 ...
 while (fread((char *)&ut, sizeof(struct utmp), 1, fp) == 1) {
  ...
  (void)fseek(fp, (long)-sizeof(struct utmp), 1);
  (void)fwrite((char *)&ut, sizeof(struct utmp), 1, fp);
  (void)fseek(fp, (long)0, 1);
  rval = 1;
 }
 (void)fclose(fp);
 return(rval);
}
# 136 "C:\\Users\\lsc\\Desktop\\testcase\\uucp-1.07\\contrib\\tstout.c"
static void
     ...
     const char *line, *name, *host;
{
 ...
 if ((fd = open("/usr/adm/wtmp", 1|0x0008, 0)) < 0)
  return;
 if (!fstat(fd, &buf)) {
