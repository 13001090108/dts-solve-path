...
public class CParser_GCC_1 extends CParser/*@bgen(jjtree)*/implements CParser_GCCTreeConstants, CParser_GCCConstants {/*@bgen(jjtree)*/
	private static final Logger logger = Logger.getLogger(CParser_GCC_1.class);
  protected JJTCParserState jjtree = new JJTCParserState();public ASTTranslationUnit createAST(java.io.StringReader input) {
        try {
                        ...
                        CParser parser = new CParser_GCC_1(ccs);
        ...
        void error_skipto(int kind,Exception in_exception) throws Exception{
        	if(Config.OutputParserException) {
...
//gcc
  ...
  public CParser_GCC_1(CharStream stream) {
  ...
  public CParser_GCC_1(CParser_GCCTokenManager tm) {
    token_source = tm;
    token = new Token();
    token.next = jj_nt = token_source.getNextToken();
    jj_gen = 0;
