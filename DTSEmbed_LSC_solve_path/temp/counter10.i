# 1 "E:\\TESTCASE\\\345\215\225\345\205\203\345\206\205\\test\\counter.c"
# 1 "<built-in>"
# 1 "<command line>"
...
# 8 "E:\\TESTCASE\\\345\215\225\345\205\203\345\206\205\\test\\counter.c" 2
...
# 9 "E:\\TESTCASE\\\345\215\225\345\205\203\345\206\205\\test\\counter.c" 2
# 1 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/malloc.h" 1
# 10 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/malloc.h"
# 1 "/usr/lib/gcc/i686-pc-cygwin/3.4.4/include/stddef.h" 1 3 4
# 11 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/malloc.h" 2


# 1 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/machine/malloc.h" 1
# 14 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/malloc.h" 2
# 22 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/malloc.h"
struct mallinfo {
  int arena;
  int ordblks;
  int smblks;
...
extern unsigned int malloc_usable_size (void *);
# 112 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/malloc.h"
extern void * valloc (unsigned int);
...
extern void * pvalloc (unsigned int);
...
extern int malloc_trim (unsigned int);
# 138 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/malloc.h"
extern void mstats (char *);
# 10 "E:\\TESTCASE\\\345\215\225\345\205\203\345\206\205\\test\\counter.c" 2
# 1 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/math.h" 1
...
# 1 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/machine/ieeefp.h" 1
# 7 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/math.h" 2
...
# 111 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/math.h"
...
# 148 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/math.h"
typedef float float_t;
typedef double double_t;
# 175 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/math.h"
...
# 235 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/math.h"
...
# 429 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/math.h"
...
# 486 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/math.h"
extern int *__signgam (void);
# 497 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/math.h"
struct exception
...
# 552 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/math.h"
...
# 572 "C:/Program Files (x86)/DTS/DTS/DTSGCC/include/math.h"

# 11 "E:\\TESTCASE\\\345\215\225\345\205\203\345\206\205\\test\\counter.c" 2
...
void push_ops(char x);
void push_ovs(double x);
char pop_ops();
double pop_ovs();
...
int main(int argc, char* argv[]) {
 printf("ÇëÊäÈëËãÊõ±í´ïÊ½£¬ÒÔ»Ø³µ½áÊø\n");
 printf("%f\n",EvaluateExpression( ));
 getc(((__getreent())->_stdin));
 describe();
...
double Operate(double a,char theta,double b) {
 double c;
   ...
   c=a+b;
# 239 "E:\\TESTCASE\\\345\215\225\345\205\203\345\206\205\\test\\counter.c"
 return c;
}
...
double EvaluateExpression( ) {
 ...
 int cache_Len=0,i,j,flag=0;
 double a,b,curnum;
 char stack_x,theta,input_c,buff[100];
 inistack_ops();
 push_ops('\n');
 inistack_ovs();
 input_c=getc(((__getreent())->_stdin));
 stack_x=gettop_ops();
 while(input_c!='\n'||stack_x!='\n') {
  if (char_In(input_c)) {
   input_h=input_c;
   ...
   switch (Precede(stack_x,input_c)) {
    ...
    case '>':
     ...
     b=100;
     a=200;
     double h = Operate(a,theta,b);
     push_ovs(h);
     break;
   }

  } else if((input_c>='0'&&input_c<='9')||input_c=='.') {
   if(input_h==')'){
    printf("ÊäÈëÓÐÎó\n");
    exit(0);
   }
...
void sucessOfJunior(int m ,int n) {
  a = 1000;
  a ++;
  int i;
  for( i = 1 ; i < 10 ; i ++) {
